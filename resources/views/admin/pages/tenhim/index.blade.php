...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('admin-tenhim-add') }}" class="button text-white bg-theme-1 shadow-md mr-2">{{ $page_title }} нэмэх</a>
        </div>
        <!-- BEGIN: Data List -->
    ...
    <div class="modal" id="delete-confirmation-modal">
        <div class="modal__content">
            <form action="{{ route('admin-tenhim-delete-ajax') }}" method="post">
            @csrf
