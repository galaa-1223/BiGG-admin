...
@section('head')
    <title>{{ $page_title.' :: '.config('app.admin_title') }}</title>
@endsection
    ...
    <div class="flex">
        ...
        <nav class="side-nav">
            <a href="" class="intro-x flex items-center pl-5 pt-4">
                <img alt="Midone Tailwind HTML Admin Template" class="w-8" src="{{ asset('dist/images/logo.svg') }}">
            ...
            <ul>
                @foreach (config('app.admin_side_menu') as $menu)
                    @if ($menu == 'devider')
