...
class MergejilBagshController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        switch ($request->input('action')) {
            case 'save':
                return redirect()->route('admin-mergejil_bagsh')->with('success', 'Багшийн мэргэжил амжилттай нэмэгдлээ!'); 
                break;
    ...
    public function update(Request $request, $id)
    {
        ...
        switch ($request->input('action')) {
            case 'save':
                return redirect()->route('admin-mergejil_bagsh')->with('success', 'Багшийн мэргэжил амжилттай засварлагдлаа!'); 
                break;
