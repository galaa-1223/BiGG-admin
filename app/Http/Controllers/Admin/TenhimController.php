...
class TenhimController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        switch ($request->input('action')) {
            case 'save':
                return redirect()->route('admin-tenhim')->with('success', 'Тэнхим амжилттай нэмэгдлээ!'); 
                break;
    ...
    public function update(Request $request, $id)
    {
        ...
        switch ($request->input('action')) {
            case 'save':
                return redirect()->route('admin-tenhim')->with('success', 'Тэнхим амжилттай засварлагдлаа!'); 
                break;
    ...
    public function delete(Request $request)
    {
        ...
        $member->delete();
        return redirect()->route('admin-tenhim')->with('success', 'Тэнхим амжилттай устгалаа!'); 
    }
}
